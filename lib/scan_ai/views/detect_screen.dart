...
import 'package:greenapp/helpers/helpers.dart';
import 'package:greenapp/models/result.dart';
...
class DetectScreen extends StatefulWidget {
  ...
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => DetectScreen());
  }
      ...
      body: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            final controller = CameraHelper.camera!;
            return Stack(
              children: <Widget>[
